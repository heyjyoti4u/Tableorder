    ...
    const channel = supabase
      ...
      .on(
        ...
        async (payload) => {
          ...
          // ✅ Agar payment 'paid' ho gayi hai, toh turant refresh karo (taaki wo list se hat jaye)
          if (updated.payment_status === 'paid') {
            window.location.reload(); // Hard refresh to clear the paid order from view
            return;
          }

          // ✅ Sirf apne orders ke liye refresh karo
